...
<?php require_once "includes/testmonial.php"; ?>
<footer>
    <div class="container margin_60_35">
        <div class="row">
            <div class="col-lg-5 col-md-12 p-r-5">
                <p><img src="img/logo_placeholder.png" height="50" alt=""></p>
                <p>Voyages Cleopatra offers you a large selection of travel services. We will be there for you before, during and after your trip!</p>
                <div class="follow_us">
                    <ul>
                        <li>Follow us</li>
            ...
            <div class="col-lg-3 col-md-6 ml-lg-auto">
                ...
                <ul class="links">
                    ...
                    <li><a href="tours.php">Extra Tours</a></li>
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <ul class="contacts">
                    <li><a href="https://wa.me/16136324800" class="d-flex">
                    <i>
                    ...
                    18 666 324 800</a></li>
                    <li><a href="tel: 18666324801"><i class="ti-mobile"></i> 18 666 324 801</a></li>
                    <li><a href="mailto: info@godiscoveregypt.com"><i class="ti-email"></i> info@godiscoveregypt.com</a></li>
                </ul>
                <div id="newsletter">
                <h6>Newsletter</h6>
                ...
                <ul id="footer-selector">
                    <li>
                        <div class="styled-select" id="lang-selector">
                            <select>
                                <option value="Canada-English" selected>Canada - English</option>
                                <option value="Canada-French">Canada - French</option>
                                <option value="USA-English">USA - English</option>
                                <option value="Europe-English">Europe - English</option>
                            </select>
                        </div>
                    </li>
                    <li>
                        <div class="styled-select" id="currency-selector">
                            <select>
                                <option value="CA Dollars" selected>Candian Dollars</option>
