<div class="bg_color_1">
    <nav class="secondary_nav sticky_horizontal">
				<div class="container">
					<ul class="clearfix">
						<li><a href="#tour_description" class="active">Description</a></li>
				...
				<div class="row">
					<div class="col-lg-8">
						<section id="description" style="border-bottom: 0px;">
							...
							<hr>
							<div id="itinerary">
							    <h3>Itinerary <small>(3 days)</small></h3>
							<p>
							...
							<!-- End Map -->
							<div id="packages">
							    <div class="margin_tabs">
								<div id="tabs" class="tabs">
									<nav>
										<ul>
											<li><a href="#section-1"><i class="pe-7s-paper-plane"></i>Regular<em>Regular Plan</em></a></li>
											<li><a href="#section-2"><i class="pe-7s-plane"></i>Luxury<em>Luxury Plan</em></a></li>
											<li><a href="#section-3"><i class="pe-7s-rocket"></i>Superior<em>Superior Plan</em></a></li>
										</ul>
									</nav>
									<div class="content">
													...
													<div class="box_pricing">
														...
														<ul>
															<li><strong>Triple Room</strong> starting from
																<div class="price">
																	<sup>$</sup>15<em>/person</em>
																</div>
															</li>
															<hr>
															<li><strong>Double Room</strong> starting from
																<div class="price">
																	<sup>$</sup>15<em>/person</em>
																</div>
															</li>
															<hr>
															<li><strong>Single Room</strong> starting from
																<div class="price">
																	<sup>$</sup>15<em>/person</em>
																</div>
															</li>															
