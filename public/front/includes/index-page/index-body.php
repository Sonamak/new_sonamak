<div class="container container-custom margin_80_0">
			...
			<div id="reccomended" class="owl-carousel owl-theme">
				...
				<div class="item">
					<div class="box_grid">
						...
						<div class="wrapper">
							<h3><a href="tour-details.php">Notredam</a></h3>
							<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
				...
				<div class="item">
					<div class="box_grid">
						...
						<div class="wrapper">
							<h3><a href="tour-details.php">Versailles</a></h3>
							<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
				...
				<div class="item">
					<div class="box_grid">
						...
						<div class="wrapper">
							<h3><a href="tour-details.php">Pompidue Museum</a></h3>
							<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
				...
				<div class="item">
					<div class="box_grid">
						<figure>
							<a href="#0" class="wish_bt"></a>
							<a href="tour-details.php"><img src="img/tour_5.jpg" class="img-fluid" alt="" width="800" height="533"><div class="read_more"><span>Read more</span></div></a>
							<small>Walking</small>
						</figure>
						<div class="wrapper">
							<h3><a href="tour-details.php">Tour Eiffel</a></h3>
							<p>Id placerat tacimates definitionem sea, prima quidam vim no. Duo nobis persecuti cu.</p>
		...
		<div class="container container-custom margin_30_95">
			<section class="add_bottom_45">
				<div class="main_title_3">
					<span><em></em></span>
					<h2>Popular tours and Accommodations</h2>
					<p>Cum doctus civibus efficiantur in imperdiet deterruisset.</p>
				</div>
				<div class="row">
					<div class="col-xl-3 col-lg-6 col-md-6">
						<a href="tour-details.php" class="grid_item">
							<figure>
								...
								<img src="img/tour_1.jpg" class="img-fluid" alt="">
								<div class="info">
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<a href="tour-details.php" class="grid_item">
							<figure>
								...
								<img src="img/tour_2.jpg" class="img-fluid" alt="">
								<div class="info">
									<div class="cat_star"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
									<h3>Concorde tour </h3>
								</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<a href="tour-details.php" class="grid_item">
							<figure>
								...
								<img src="img/tour_3.jpg" class="img-fluid" alt="">
								<div class="info">
									<div class="cat_star"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
									<h3>Louvre tour</h3>
								</div>
					...
					<div class="col-xl-3 col-lg-6 col-md-6">
						<a href="tour-details.php" class="grid_item">
							<figure>
								<div class="score"><strong>8.9</strong></div>
								<img src="img/tour_4.jpg" class="img-fluid" alt="">
								<div class="info">
									<div class="cat_star"><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i><i class="icon_star"></i></div>
									<h3>Park Yatt tour</h3>
								</div>
							</figure>
						</a>
					</div>
				...
				<!-- /row -->
				<a href="tours-grid-isotope.php"><strong>View all (157) <i class="arrow_carrot-right"></i></strong></a>
			</section>
			<!-- /section -->
			...
			<div class="banner mb-0">
				<div class="wrapper d-flex align-items-center opacity-mask" data-opacity-mask="rgba(0, 0, 0, 0.3)">
					<div>
						<small>Featured Destination Tour</small>
						<h3>Your Perfect<br>Advenure Experience</h3>
						<p>Activities and accommodations</p>
						<a href="tour-details.php" class="btn_1">Read more</a>
					</div>
				</div>
				<!-- /wrapper -->
			</div>
		...
		<div class="bg_color_1">
			<div class="container margin_80_55">
				<div class="main_title_2">
					<span><em></em></span>
					<h3>News and Events (latest blog Posts)</h3>
					<p>Cum doctus civibus efficiantur in imperdiet deterruisset.</p>
				</div>
				<div class="row">
					<div class="col-lg-6">
						<a class="box_news" href="/blog-post.php">
				...
				<!-- /row -->
				<p class="btn_home_align"><a href="blog.php" class="btn_1 rounded">View all news</a></p>
			</div>
			<!-- /container -->
		</div>
		<!-- /bg_color_1 -->
				...
				<div class="col-lg-5 col-md-6 float-right wow" data-wow-offset="250">
					<div class="block-reveal">
						...
						<div class="box_1">
							...
							<a href="contacts.php" class="btn_1 rounded">Contact us</a>
						</div>
					</div>
				</div>
			</div>
