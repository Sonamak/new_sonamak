...
<div class="main-container container-fluid">
    <div class="card mt-4 card-full">
        ...
        <form class="ajax-form" method="post" action="{{ route($route) }}" appendToData="mergeModelRefrences" redirect="{{ route('$model') }}">
            <div class="card-body card-full">

                

                <input value="@if($model->id) {{ $model->id }} @endif" type="hidden" name="id">
            </div>
