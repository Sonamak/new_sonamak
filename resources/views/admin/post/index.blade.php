                        ...
                        <div class="col-md-9">
                            ...
                            <div class="d-flex align-items-center col-md-8 p-0">
                                ...
                                <div class="switcher mb-0 d-flex ms-auto">
                                    ...
                                    <div class="checkbox">
                                        <input type="checkbox" name="onoffswitch" class="onoffswitch-checkbox feature feature_post_check" route="" model_id="{{ $post->id }}" id="myonoffswitch_{{$post->id}}" @if($post->feature) checked @endif>
...
<script>
    ...
    function delete$post(e) {

        $(`#posts_{{$post->id}}`).remove();
                        ...
                        <div class="row mt-4">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="d-flex align-items-center col-md-8 p-0">
                                        ...
                                        <button class="btn-secondary mx-2" delete_message="Slow Down Howdy! We Have to warn you that this action is irrevesable and this data will be permenantly delete" route="/post/delete/${item.id}" delete_id="${item.id}" callback="">
                                            Delete
                                        </button>
