            ...
            <div class="project_container w-100" style="background: {{ $project->background }} ";>
               <div class="d-flex justify-content-center">
                    ...
                    <div class="mockup_layout w-50">
                        <img src="@if($project->mockup) {{ asset('storage/project/large/'.$project->mockup->name) }} @else {{ asset('storage/system/large/project_mockup.png') }} @endif" alt="mockup" class="my-auto w-100">
                    </div>
               </div>
               <div class="d-flex justify-content-between mt-3">
                    ...
                    <div class="coders_logos w-50">
                            <div class="row justify-between w-100 ps-5">
                                ...
                                <div class="w-25 mx-2">
                                    @if($coder->thumbnail)
                                    <img src="{{ asset('storage/coder/small/'.$coder->thumbnail->name) }}" alt="coder" width="45px">
                                    @endif
                                </div>
                                @endforeach
                            </div>
