<form class="ajax-form" action="{{ route('banner.store') }}" method="post">
    <div class="card-header w-100 d-flex">
        <h4 class="card-title mb-1">Contact Map</h4>
    </div>
    <div class="form-group col-md-12">
        ...
        <Div class="d-flex">
            <div class="group w-100">
                <input placeholder="Added Google Embedded" class="form-control mx-2" name="upper_text_in_english" value="@if($banner){{$banner->upper_text_in_english}}@endif">
            </div>
        </Div>
