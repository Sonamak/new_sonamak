<form class="ajax-form" action="{{ route('banner.store') }}" method="post">
    ...
    <div class="form-group col-md-12">
        ...
        <div class="d-flex mb-2">
            ...
            <div class="group w-100">
                <input placeholder="Button Text" class="form-control mx-2" value="@if($banner){{$banner->btn_text}}@endif" name="btn_text">
                <p class="error error_btn_text"></p>
            </div>
        </div>

        <div class="row mb-4">
            <div class="col-sm-12 col-md-4 mg-t-10 mg-sm-t-0">
                <input type="file" class="dropify" data-default-file="@if($banner->background)  {{ asset('storage/banner/large/'.$banner->background->name) }} @endif" data-height="200"  name="hero"/>
            </div>
