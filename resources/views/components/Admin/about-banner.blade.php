<form class="ajax-form" action="{{ route('info.store') }}" method="post">
    <div class="card">
    ...
    <div class="extra_about_container">
        ...
        <div class="row section">
            <div class="col-md-12 mb-2 mt-2">
                <input type="text" class="form-control" name="extra[index][title]" placeholder="Enter Title" value="{{$extra->title}}">
            </div>
            <div class="col-md-12">
                <textarea type="text" class="form-control" name="extra[index][value]" placeholder="Enter Description">{{$extra->value}}</textarea>
            </div>
